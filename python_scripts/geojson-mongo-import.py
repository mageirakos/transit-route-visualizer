...
#
# example usage:
# given an input file named "routes.geojson" having GeoJSON mutliline objects
# into destination DB "bus_ece" and collection named "routes"
#
# python geojson-mongo-import.py -f routes.geojson -d bus_ece -c routes
# python geojson-mongo-import.py -f stops.geojson -d bus_ece -c stops
#
#
